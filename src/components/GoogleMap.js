(function (global, factory) {
  if (typeof exports !== "undefined") {
    factory(exports, require('./GoogleApiComponent'), require('./Marker'), require('./InfoWindow'), require('react'), require('prop-types'), require('react-dom'), require('../lib/String'), require('../lib/cancelablePromise'), require('invariant'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  Map.defaultProps = {
    ...
    styles: [
            {elementType: 'geometry', stylers: [{color: '#008DD3'}]},
            {elementType: 'labels.text.stroke', stylers: [{color: '#008DD3'}]},
