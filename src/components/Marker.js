  ...
  var Marker = exports.Marker = function (_React$Component) {
    ...
    _createClass(Marker, [{
      ...
      value: function renderMarker() {
        ...
        var markerIcon = new google.maps.MarkerImage('images/map/'+this.props.category+'_map.svg', null, null, null, new google.maps.Size(25,25));
        var pref = {
          map: map,
          position: position,
          icon: markerIcon,
        ...
        // console.log(this.props.amenityHoverBounce);
        this.marker = new google.maps.Marker(pref);

        if(this.props.amenityHoverBounce){
          this.marker.setAnimation(window.google.maps.Animation.BOUNCE);
          // this.props.currentMarkerObject(this.marker);
        }
        // else{
        ...
        //bounce effect
          // this.marker.setAnimation(window.google.maps.Animation.BOUNCE);
          // setTimeout(function(){ this.marker.setAnimation(null); }, 750);
          //bounce effect end
